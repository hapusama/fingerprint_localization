...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--tx-gain-db", type=float, default=60.0)
    parser.add_argument("--rx-gain-db", type=float, default=50.0)
    parser.add_argument("--tx-device-addr", default="serial=2603160,num_send_frames=1024")
    parser.add_argument("--rx-device-addr", default="serial=2512552,num_recv_frames=512")
